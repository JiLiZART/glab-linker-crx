...
import type { SettingsFormControl, SettingsFormValues } from '@src/types';
...
function MergeRequestPreview() {
  const values = useFormValues<SettingsFormValues>();
...
export const DisplaySettings = ({ control }: { control: SettingsFormControl }) => {
  return (
    <Card className="p-6">
