import type { EnvironmentResponse, MergeRequestResponse } from '../services';

export function transformMRData(data: MergeRequestResponse, envData?: EnvironmentResponse) {
  if (!data) {
